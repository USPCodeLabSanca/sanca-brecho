      ...
      <main className="flex-grow py-5">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-center text-xl font-bold m-4">Detalhes da compra</h1>
            <div className="flex flex-col">
              {loadingSale ? (
                <Spinner />
              ) : errorSale ? (
                <p className="text-red-500 text-center">Erro ao carregar detalhes da compra: {errorSale}</p>
              ) : sale ? (
                <SaleDetails sale={sale} context="buyer" onReviewSuccess={handleReviewSuccess}/>
              ) : (
